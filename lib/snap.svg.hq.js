...
// └────────────────────────────────────────────────────────────┘ \\
// snap.js、raphael.js Eve 存在命名空相同覆盖冲突 重新命名 eve 为 eve2 
// modify by huangqing 2018-11-06
...
(function (glob) {
    ...
    (typeof module != "undefined" && module.exports) ? (module.exports = eve2) : (typeof define === "function" && define.amd ? (define("eve2", [], function() { return eve2; })) : (glob.eve2 = eve2));
})(this);
...
(function (glob, factory) {
    ...
    if (typeof define == "function" && define.amd) {
        ...
        var eve2 = require("eve2");
        module.exports = factory(glob, eve2);
    } else {
        // Browser globals (glob is window)
        // Snap adds itself to window
        factory(glob, glob.eve2);
    }
...
Snap.plugin(function (Snap, Element, Paper, glob, Fragment) {
    ...
    (function () {
        ...
        function gradient(defs, str) {
            var grad = eve2("snap.util.grad.parse", null, str).firstDefined(),
                el;
            if (!grad) {
                return null;
            }
...
Snap.plugin(function (Snap, Element, Paper, glob) {
    ...
    dragMove = function (e) {
        ...
        while (j--) {
            ...
            // o && eve2("snap.drag.over." + dragi.el.id, dragi.el, o);
            x += scrollX;
            y += scrollY;
    ...
    //     f ? eve2.on("snap.drag.over." + this.id, f) : eve2.unbind("snap.drag.over." + this.id);
    // };
    /*\
     * Element.undrag
     [ method ]
